...
const PDF_UPLOAD_COST: number = 50;
const CHAT_COST: number = 10;

const DAILY_CREDIT_AWARD: number = 50;
...
export {
  ...
  COST, PDF_UPLOAD_COST, CHAT_COST,
  DAILY_CREDIT_AWARD,
  CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET,
  MONTHLY_TOTAL_AMOUNT, PRO_ACCESS_AMOUNT, PRO_ACCESS_LIMIT,
