...
import { Trash2, PlayCircle, BookOpen, ListChecks, Wand2 } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
        <div className="space-y-2 me-auto">
          ...
          <p className="text-muted-foreground max-w-md ms-2">
            Review your past assessments or retake a quiz to improve your score and knowledge.
          </p>
        </div>
        <Button onClick={() => router.push("/quiz/select")} className="not-md:w-full ms-auto">
          <ListChecks />
          Generate New Quiz
        </Button>
      </div>
      ...
      {quizzes.length === 0 ? (
        <div className="text-center py-20 border-2 border-dashed rounded-xl space-y-4">
          ...
          <Button variant="outline" onClick={() => router.push("/quiz/select")}>
            <ListChecks />
