...
export function Hero() {
  ...
  return (
    <section className={`${pathname === "/" ? "pt-10" : ""} animate-up relative min-h-screen w-full flex flex-col justify-center items-center overflow-hidden bg-background`}>
      ...
      <div className="absolute -top-24 -left-24 w-72 h-72 md:w-96 md:h-96 bg-primary/10 rounded-full blur-3xl opacity-70 pointer-events-none transform-gpu" />
      <div className="absolute -bottom-24 -right-24 w-72 h-72 md:w-96 md:h-96 bg-blue-500/10 rounded-full blur-3xl opacity-70 pointer-events-none transform-gpu" />
      ...
      <div className="relative z-10 px-4 md:px-8 fill-mode-both">
        <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
          ...
          <Badge variant="secondary" className="px-4 py-2 gap-2 text-sm bg-secondary/80 border-secondary-foreground/10 shadow-sm">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground sm:text-xl leading-relaxed bg-background/30 md:bg-transparent p-2 rounded-xl">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 w-full sm:w-auto mt-6">
            ...
            <Button variant="outline" size="lg" className="h-14 px-10 text-lg bg-background/50" asChild>
            ...
            {isInstallable && (
              <Button
                size="lg"
                className="h-14 px-10 text-lg gap-2 text-white border-0 transition-all duration-500 bg-linear-to-r from-orange-700 via-orange-400 to-orange-700 dark:from-orange-900 dark:via-orange-500 dark:to-orange-900 bg-size-[200%_auto] hover:bg-position-[right_center]"
...
function FloatingDoc({
  ...
  return (
    <Card
      className={`absolute flex flex-col gap-3 bg-card/90 border-muted/50 shadow-xl ${widthClass} ${paddingClass} ${mobileOpacity} ${className} pointer-events-none z-0`}
